...
class Fusion_MLP(nn.Module):
    def __init__(self, emb_size, prompt_size):
        ...
        self.layers = nn.ModuleList(
            ...
            [nn.Linear(emb_size,prompt_size)])#4444444444444444444new new # 嵌入特征从320(64+256)变化为64
        self.activation = nn.Tanh()
...
class TCMRGCL(nn.Module):  # input_dim=64,hidden_dim=256,output_dim=256
    ...
    def _prompts_u_embeddings_fusion(self, fenceng_sym_embedding,fenceng_herb_embedding):
        ...
        prompted_sym_emb = self.fusion_mlp(fenceng_sym_embedding)
        prompts_herb_emb = self.fusion_mlp(fenceng_herb_embedding)
    ...
    def train(self):
        ...
        for epoch in range(self.epoch):
            ...
            for n, batch in enumerate(self.origin_data['train_loader']):
                ...
                # todo:整合embedding
                prompted_sym_emb,prompted_herb_emb = self._prompts_u_embeddings_fusion(fenceng_sym_embedding,fenceng_herb_embedding)
