...
if __name__ == '__main__':
    ...
    while loop:
        ...
        # Get ss similarity and hh similarity from s-h
        ...
        # Calculate the Jaccard similarity in s-s and h-h to indicate the probability of co-occurrence of symptom-symptom (TCM-TCM) and to measure the interaction between symptoms (TCM).
        ...
        adj_norm_ss = adj_norm_ss.to_dense() * jacc_ss
        ...
        from model import TCMRGCL

        model = TCMRGCL(adj_norm_sh.shape[0], adj_norm_sh.shape[1], adj_norm_sh, adj_norm_ss,
        ...
        for j, test_batch in enumerate(test_loader):
            ...
            for i, (hid, sid) in enumerate(zip(ph.cpu(), ps.cpu())):
                ...
                output_predictherbs.append(predict_herbs)
