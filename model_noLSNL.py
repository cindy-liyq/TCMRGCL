...
class Fusion_MLP(nn.Module):
    def __init__(self, emb_size, prompt_size):
        ...
        self.layers = nn.ModuleList(
            ...
            [nn.Linear(prompt_size, emb_size)])#4444444444444444444new new # 嵌入特征从320(64+256)变化为64
        self.activation = nn.Tanh()
...
class TCMRGCL(nn.Module):  # input_dim=64,hidden_dim=256,output_dim=256
    ...
    def _prompts_u_embeddings_fusion(self, prompts_sym, sym_emb,prompts_herb,herb_emb):
        ...
        prompted_sym_emb = self.fusion_mlp(prompts_sym)
        prompts_herb_emb = self.fusion_mlp(prompts_herb)
    ...
    def train(self):
        ...
        for epoch in range(self.epoch):
            ...
            for n, batch in enumerate(self.origin_data['train_loader']):
                ...
                # todo:整合embedding
                prompted_sym_emb,prompted_herb_emb = self._prompts_u_embeddings_fusion(prompts_sym, sym_emb,prompts_herb,herb_emb,)
            ...
            import pickle
            with open("tsne/tsne/best_noLSNL_sym_emb.pkl", 'wb') as file_1:
                pickle.dump(best_sym_emb,file_1)
            with open("tsne/tsne/best_noLSNL_hreb_emb.pkl", 'wb') as file_2:
